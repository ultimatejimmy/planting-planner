...
If you know your last frost date or zip code, you can enter it.  Otherwise the app uses the Geolocation API and [Geocoding API](https://geocode.maps.co/docs/),  along with the [Frost Date API](https://apis.joelgrant.dev/).  This is based on 30% probability of hitting 32 degrees F.
